...
-- This library allow change market skins on heroes
...
-- wearables.lua has functions to modify cosmetics
require('wearables')
...
function GameMode:InitGameMode()
  ...
  GameRules:GetGameModeEntity():SetModifyGoldFilter( Dynamic_Wrap( GameMode, "FilterGold" ), self ) --SET GOLD per kill unit
