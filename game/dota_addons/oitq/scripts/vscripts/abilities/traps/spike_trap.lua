spike_trap = class({})
LinkLuaModifier( "modifier_spike_trap_lua", "abilities/traps/modifier_spike_trap_lua.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_spike_trap_thinker_lua", "abilities/traps/modifier_spike_trap_thinker_lua.lua", LUA_MODIFIER_MOTION_NONE )
