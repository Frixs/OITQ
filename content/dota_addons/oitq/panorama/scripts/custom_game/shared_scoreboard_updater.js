		...
		if ( playerPortrait )
		{
			if ( playerInfo.player_selected_hero !== "" )
			{
				...
				if (playerInfo.player_selected_hero == "npc_dota_hero_juggernaut")
					playerPortrait.SetImage( "file://{images}/custom_game/juggernaut.png" );
				else if (playerInfo.player_selected_hero == "npc_dota_hero_bloodseeker")
					playerPortrait.SetImage( "file://{images}/custom_game/bloodseeker.png" );
				else if (playerInfo.player_selected_hero == "npc_dota_hero_dark_seer")
					playerPortrait.SetImage( "file://{images}/custom_game/dark_seer.png" );
				else if (playerInfo.player_selected_hero == "npc_dota_hero_meepo")
					playerPortrait.SetImage( "file://{images}/custom_game/meepo.png" );
				else if (playerInfo.player_selected_hero == "npc_dota_hero_bounty_hunter")
					playerPortrait.SetImage( "file://{images}/custom_game/bounty_hunter.png" );
				else
